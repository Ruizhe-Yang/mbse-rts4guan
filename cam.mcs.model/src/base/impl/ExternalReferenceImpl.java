...
public class ExternalReferenceImpl extends UtilityElementImpl implements ExternalReference {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.EXTERNAL_REFERENCE;
	}
	...
	public NotificationChain basicSetLocation(LangString newLocation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasePackage.EXTERNAL_REFERENCE__LOCATION, oldLocation, newLocation);
	...
	public void setLocation(LangString newLocation) {
		if (newLocation != location) {
			...
			if (location != null)
				msgs = ((InternalEObject)location).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasePackage.EXTERNAL_REFERENCE__LOCATION, null, msgs);
			if (newLocation != null)
				msgs = ((InternalEObject)newLocation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasePackage.EXTERNAL_REFERENCE__LOCATION, null, msgs);
			msgs = basicSetLocation(newLocation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.EXTERNAL_REFERENCE__LOCATION, newLocation, newLocation));
	}
	...
	public NotificationChain basicSetType(LangString newType, NotificationChain msgs) {
		...
		type = newType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasePackage.EXTERNAL_REFERENCE__TYPE, oldType, newType);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setType(LangString newType) {
		if (newType != type) {
			NotificationChain msgs = null;
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasePackage.EXTERNAL_REFERENCE__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasePackage.EXTERNAL_REFERENCE__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.EXTERNAL_REFERENCE__TYPE, newType, newType));
	}
	...
	public NotificationChain basicSetMetadata(LangString newMetadata, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasePackage.EXTERNAL_REFERENCE__METADATA, oldMetadata, newMetadata);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMetadata(LangString newMetadata) {
		if (newMetadata != metadata) {
			NotificationChain msgs = null;
			if (metadata != null)
				msgs = ((InternalEObject)metadata).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasePackage.EXTERNAL_REFERENCE__METADATA, null, msgs);
			if (newMetadata != null)
				msgs = ((InternalEObject)newMetadata).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasePackage.EXTERNAL_REFERENCE__METADATA, null, msgs);
			msgs = basicSetMetadata(newMetadata, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.EXTERNAL_REFERENCE__METADATA, newMetadata, newMetadata));
	}
	...
	public EList<ImplementationConstraint> getImplementationConstraint() {
		if (implementationConstraint == null) {
			implementationConstraint = new EObjectContainmentEList<ImplementationConstraint>(ImplementationConstraint.class, this, BasePackage.EXTERNAL_REFERENCE__IMPLEMENTATION_CONSTRAINT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasePackage.EXTERNAL_REFERENCE__LOCATION:
				return basicSetLocation(null, msgs);
			case BasePackage.EXTERNAL_REFERENCE__TYPE:
				return basicSetType(null, msgs);
			case BasePackage.EXTERNAL_REFERENCE__METADATA:
				return basicSetMetadata(null, msgs);
			case BasePackage.EXTERNAL_REFERENCE__IMPLEMENTATION_CONSTRAINT:
